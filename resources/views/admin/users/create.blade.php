<x-app-layout>
    <!-- Header -->
    @include('layouts.navigation', ['currentPage' => 'Create User'])

    <div class="py-12 bg-gray-100">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="container mx-auto p-6">
                    <h1 class="text-3xl font-bold mb-6 text-center" style="color: #d4af37;">Create New User</h1>
                        ...
                        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="name" id="name"
                                    class="w-full border rounded py-2 px-3 text-gray-700" value="{{ old('name') }}"
                                    required>
                            </div>
                            <div class="mb-4">
                                <label for="email" class="block text-gray-700 font-bold mb-2">Email</label>
                                <input type="email" name="email" id="email"
                                    class="w-full border rounded py-2 px-3 text-gray-700" value="{{ old('email') }}"
                                    required>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="flex justify-end">
                                ...
                                <button type="submit"
                                    ...
                                    style="background-color: #d4af37;">Create User</button>
                            </div>
                        </form>
                    </div>
                </div>
